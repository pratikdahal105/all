...
{{--                    <a href="http://allrahimmanpower.com/" class="btn btn-light font-weight-bold" target="_blank">@lang('content.footer_link')</a>--}}
                    <div class="row mt-3">
                        <figure class="figure col-4">
                            ...
                            <figure class="figure col-4">
                                <a href="{{asset('uploads/profiles-contents.pdf')}}" target="_blank"><img src="{{ asset('images/pdf.png') }}" width="100" height="100" class="figure-img img-fluid rounded"></a>
                                <figcaption class="figure-caption text-center"><a href="{{asset('uploads/profiles-contents.pdf')}}" target="_blank" style="text-decoration: none; color: white;">弊社資料</a></figcaption>
                            </figure>
                          <figure class="figure col-4">
